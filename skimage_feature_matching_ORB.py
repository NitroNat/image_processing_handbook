...
# Create two different transformed images
...
keypoints1 = descriptor_extractor.keypoints # coordinates
...
# pair of matches items by indices from two sets of keypoints
